...
async function testResearchWithoutLangSmith() {
  try {
    console.log('Testing research API without LangSmith...');
    ...
    const response = await fetch('http://localhost:3000/api/research', {
      ...
      body: JSON.stringify({
        ...
        model: 'gpt-3.5-turbo'
        // No langsmithApiKey provided - should use simple agent
      })
    });
